            ...
            <div className="w-11/12  mx-auto flex  lg:h-[27rem] flex-col lg:flex-row  items-start gap-10">
                ...
                <div className="w-full lg:w-1/2 flex py-2 gap-10 items-start justify-between h-full flex-col">
                    <div className="flex items-start gap-5 flex-col">
                        ...
                        <div data-aos="fade-left" data-aos-duration="1000" className="font-bold text-3xl">Hi, I'm Bethel Nnadi (Belziee)</div>
                    </div>
                    <div className="flex items-start gap-3 flex-col">
                        <div className="w-full bg-[#2d2e32] gap-3 h-12 flex  items-start">
                            <div className="h-full w-1.5 bg-primary"></div>
                            <div data-aos="fade-right" data-aos-duration="1000" className=" text-base self-center">Fullstack Software & Smart Contract Developer </div>
                        </div>
                        <div data-aos-duration="1000" data-aos="fade-up" className="font-bold tracking-wide text-[1rem]">
                            I'm a dedicated computer engineer and skilled full stack developer based in Nigeria, West Africa, with expertise in software and smart contract development. I have a strong foundation in both front-end and back-end technologies, and my work is driven by an enthusiasm for problem-solving and a commitment to creating impactful digital experiences.
                        </div>
                        <div data-aos-duration="1000" data-aos="fade-down" className="font-bold tracking-wide text-[1rem]">
                            Whether building decentralized applications, developing efficient APIs, crafting seamless UIs, or optimizing server performance, I bring a detail-oriented approach to every project. Let's build innovative and scalable solutions together!
                        </div>
